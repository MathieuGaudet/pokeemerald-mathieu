...
#define B_LEADERS_USE_ITEMS             FALSE      // If FALSE, Gym Leaders, Elite Four members, and Champions will never use items (Potions, Full Restores, etc.) during battle.
...
#define B_OBEDIENCE_ENABLED             FALSE      // If FALSE, Pokémon never disobey commands, regardless of level or badge count.
