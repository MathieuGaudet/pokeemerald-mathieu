...
#define TRAINER_WATTSON_MATHIEU             862
#define TRAINER_FLANNERY_MATHIEU            863

// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is no more space for additional trainers before trainer flag space overflows
